function  WayPoint = WP_2ship(v_os,course_os,pos_os,v_ts,course_ts,pos_ts,TSlength,changeLabel)
...
CPA = computeCPA(v_os,course_os,pos_os,v_ts,course_ts,pos_ts,time);
